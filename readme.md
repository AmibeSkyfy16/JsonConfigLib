...
```
plugins {
    id("org.jetbrains.kotlin.plugin.serialization") version "1.9.0" // Use for annotation like @kotlinx.serialization.Serializable
}
...
dependencies {
    implementation("ch.skyfy.jsonconfiglib:json-config-lib:4.0.0")!!
}
```
